    ...
    return (
        <div className="drawer drawer-mobile">
            ...
            <div className="drawer-content  ">
                <label for="my-drawer-2" className=" text-gray-500 drawer-button lg:hidden"><MdOutlineArrowForwardIos className='font-bold text-4xl'></MdOutlineArrowForwardIos></label>
